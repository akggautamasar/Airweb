...
<body>
    ...
    <div class="container">
        ...
        <div id="move-copy-modal" class="create-new-folder">
            <span id="move-copy-title">Move Item</span>
            <div class="folder-tree" id="folder-tree">
                <!-- Folder tree will be populated here -->
            </div>
            <div class="move-copy-actions">
                <button id="move-copy-cancel">Cancel</button>
                <button id="move-item-btn" class="primary-btn">Move</button>
                <button id="copy-item-btn" class="secondary-btn">Copy</button>
            </div>
        </div>
        <!-- Move/Copy Modal End -->
        ...
        <div class="main-content">
            <div class="header">
                ...
                <div class="sort-controls">
                    ...
                    <button id="sort-order" class="sort-order-btn" data-order="desc" title="Descending">
    ...
    <script src="static/js/moveCopy.js"></script>
